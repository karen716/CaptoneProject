...
ON 
    r.user_id = u.id
WHERE
    r.police_assign = $policeAssign and r.finish ='On'";
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<td>
                        <button class='btn btn-sm btn-primary' onclick='callmodal1(\"".$row['id']."\", \"".$row['user_id']."\")'>Update</button> 
                        </td>";
...
<script type="text/javascript">
  ...
  function callmodal1(id, user_id) {
